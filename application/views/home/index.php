<h1>Dashboard</h1>
    ...
    <div class="wukar-panels">
      <div class="row">
        <div class="col-md-6 col-sm-6 margin-bottom-30">
          <div class="panel panel-success">
            <div class="panel-heading">Data Visualization</div>
            <canvas id="wukar-line-chart" height="120" width="500"></canvas>
          </div> 
      ...
      <div class="row">
        <div class="col-md-6 col-sm-6">
          <!-- Nav tabs -->
          <ul class="nav nav-tabs" role="tablist" id="wukar-tabs">
